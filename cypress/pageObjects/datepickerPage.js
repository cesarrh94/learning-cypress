...
class DatepickerPage {
    ...
    selectRangePickerDateFromToday(numbersOfDaysFromTodayStart, numbersOfDaysFromTodayEnd) {
        cy.get('[placeholder="Range Picker"]').then(input => {
            cy.wrap(input).click()
            const dateToAssertStart = selectDateFromCurrentDay(numbersOfDaysFromTodayStart)
            const dateToAssertEnd = selectDateFromCurrentDay(numbersOfDaysFromTodayEnd)
